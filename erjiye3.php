...
<header>
    <div class="mainso">
        ...
        <div class="search-area">
            <input type="text" placeholder="搜索沟帮子干豆腐" class="search-input" />
...
<!-- 沟帮子干豆腐专区 -->
<div class="tofu-section">
    <div class="section-title">沟帮子干豆腐系列</div>
    <div class="section-desc">传统手工 · 薄如蝉翼 · 豆香浓郁 · 真空包装</div>
    ...
    <div class="product-list">
        ...
        <div class="product-item">
            <a href="xiangqingye.php">
                <div class="img-box">
                    <img src="images/7.jpg" alt="沟帮子干豆腐" />
                </div>
                <div class="info">
                    <div class="name">干豆腐礼盒装</div>
        ...
        <div class="product-item">
            <a href="xiangqingye.php">
                ...
                <div class="info">
                    <div class="name">沟帮子干豆腐 1000g</div>
