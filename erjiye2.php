...
<header>
    <div class="mainso">
        ...
        <div class="search-area">
            <input type="text" placeholder="搜索沟帮子猪蹄" class="search-input" />
...
<div class="pig-section">
    <div class="section-title">沟帮子猪蹄系列</div>
    <div class="section-desc">传统熏制 · 软糯入味 · 胶原蛋白满满 · 顺丰包邮</div>
    ...
    <div class="product-list">
        ...
        <div class="product-item">
            <a href="xiangqingye.php">
                <div class="img-box">
                    <img src="images/6.jpg" alt="沟帮子熏猪蹄" />
                </div>
                <div class="info">
                    <div class="name">沟帮子熏猪蹄 400g</div>
        ...
        <div class="product-item">
            <a href="xiangqingye.php">
                ...
                <div class="info">
                    <div class="name">沟帮子熏猪蹄 500g</div>
...
<footer>
    <div class="innerframe">
        ...
        <ul class="fnav"><h2>售后服务</h2><li>售后政策</h2><li>退款说明</li></ul>
