...
<header>
    <div class="mainso">
        ...
        <div class="search-area">
            <input type="text" placeholder="搜索沟帮子烧鸡" class="search-input" />
...
<div class="chicken-section">
    <div class="section-title">沟帮子烧鸡系列</div>
    <div class="section-desc">中华老字号 · 传统熏制 · 肉质鲜嫩 · 顺丰包邮</div>
    ...
    <div class="product-list">
        ...
        <div class="product-item">
            <a href="xiangqingye.php">
                <div class="img-box">
                    <img src="images/1.jpg" alt="沟帮子熏鸡" />
                </div>
                <div class="info">
                    <div class="name">沟帮子熏鸡550g</div>
